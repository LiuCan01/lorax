...
class TreeBuilder(object):
    ...
    def __init__(self, product, arch, inroot, outroot, ssss, runtime, isolabel, domacboot=False, doupgrade=True, templatedir=None, add_templates=None, add_template_vars=None, workdir=None):

        # NOTE: if you pass an arg named "runtime" to a mako template it'll
        # clobber some mako internal variables - hence "runtime_img".
        self.vars = DataHolder(arch=arch, product=product, runtime_img=runtime,
                               runtime_base=basename(runtime),
                               inroot=inroot, outroot=outroot, ssss=ssss,
                               basearch=arch.basearch, libdir=arch.libdir,
